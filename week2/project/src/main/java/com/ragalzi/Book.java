...
public class Book extends Publication {
    ...
    public static Book createFromLines(List<String> lines) throws IllegalArgumentException, IndexOutOfBoundsException {
        ...
        return new Book(isbn, title, year, numPages, author, genre);
    }
