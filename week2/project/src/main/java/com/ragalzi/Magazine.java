...
public class Magazine extends Publication {
    ...
    public Magazine(String isbn, String title, int year, int numPages, Periodicity periodicity) {
        super(title, year, numPages);
        this.isbn = isbn;
        this.periodicity = periodicity;
    }
    ...
    public static Magazine createFromLines(
            List<String> lines) throws IllegalArgumentException, IndexOutOfBoundsException {
        ...
        return new Magazine(isbn, title, year, numPages, periodicity);
    }
